...
export const CATALOG = [
  {
    id: 'playwright',
    name: 'Playwright',
    description: 'Browser control: navigate / click / fill / screenshot. Perfect for web scraping and UI tests.',
  ...
  },
  {
    id: 'memory',
    name: 'Memory',
    description: 'Knowledge graph in a JSON file. Long-term memory across conversations.',
  ...
  },
  {
    ...
    description: 'Forces the model to think step by step. Useful for complex tasks that need a plan.',
  ...
  },
  {
    id: 'filesystem',
    name: 'Filesystem',
    description: 'Read / write / list files under allowed roots. Arguments — the list of accessible directories.',
    command: 'npx', args: ['-y', '@modelcontextprotocol/server-filesystem', '/tmp'],
    env: [], argsHint: 'List of allowed directories (space-separated in the editor)',
  },
  {
    id: 'fetch',
    name: 'Fetch',
    description: 'HTTP GET / POST for any URL. Returns body + headers.',
  ...
  },
  {
    id: 'github',
    name: 'GitHub',
    description: 'GitHub API: repos, issues, PRs, code search. Requires a Personal Access Token.',
  ...
  },
  {
    id: 'sqlite',
    name: 'SQLite',
    description: 'SQL queries against a .db file. Argument — path to the database.',
    command: 'npx', args: ['-y', '@modelcontextprotocol/server-sqlite', '/tmp/test.db'],
    env: [], argsHint: 'Path to the .db file',
  },
  {
    id: 'postgres',
    name: 'PostgreSQL (RO)',
    description: 'Read-only SQL on Postgres. Argument — connection string.',
